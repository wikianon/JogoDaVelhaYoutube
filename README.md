...
![Form Jogadores](imagens_jogo/form_pega_nome_dos_jogadores.png)

------------------
#### Mostra jogador da rodada após definir os jogadores começando pelo `X`.
![Jogador Atual](imagens_jogo/mostra_o_primeiro_jogador_apos_definir_nomes.png)

------------------
#### Alterna o jogador da rodada que será a `O`.
![Alterna Jogador](imagens_jogo/muda_de_nome_de_jogador.png)
